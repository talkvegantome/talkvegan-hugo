...
Due to a lack of statistical data it is derived by inferring the average ratio of production water usage to processing water usage from data regarding soybeans [p11](https://web.archive.org/web/20181003201254/https://www.ioes.ucla.edu/wp-content/uploads/cow-vs-almond-milk-1.pdf).

This ratio of production water usage to processing water usage came out as 0.83x (i.e. producing the oilbeans took 0.83x as much water as processing them).

This is then multiplied by 0.885 kgal to get a total of 1.07kgal. But where does the 0.885 kgal come from?
...
The input for this is naturally crucial, and the tutorial for the calculator warns:
...
But this ignores retail markup, distribution costs, not to mention the fact that the dataset we're working against is for the _Tree Nut Farming_ industry [p12](https://web.archive.org/web/20181003201254/https://www.ioes.ucla.edu/wp-content/uploads/cow-vs-almond-milk-1.pdf), not the almond _milk_ industry which skews the result of litres used per dollar much higher due to the farming industry having a much lower producer price by virtue of being further back in the value chain.
